...
namespace Player
{
    class match_proxy
    {
        ...
        public player_match_start_battle_cb start_battle(BattleMod mod, string client_uuid, List<int> role_list, UserInformation user_info)
        {
            return player_Match_Caller.get_hub(name).start_battle(mod, client_uuid, role_list, user_info);
        }
