...
export function CreateProp(level:number, propID:number) : skill.SkillBase {
    //
    let skillConfig = config.config.SkillConfig.get(propID);
    let foodConfig=config.config.FoodConfig;
    ...
    console.log("skillID:", propID, " level:", level, " value0:", value0, " value1", value1);
